...
class LivroService:
    ...
    def adicionar(self):
        ...
        try:
            ...
            id_editora = ObjectId(input('Digite o ID da editora do livro: '))
            editora: Editora = self.__editora_dao.buscar_por_id(id_editora)

            while (editora == None):
                print('Editora não existente!')
                id_editora = ObjectId(
                    input('Digite o ID da editora do livro: '))
                editora: Editora = self.__editora_dao.buscar_por_id(id_editora)
            ...
            id_autor = ObjectId(input('Digite o ID do autor do livro: '))
    ...
    def remover(self):
        ...
        try:
            livro_id = ObjectId(input('Digite o ID do livro para excluir: '))
    ...
    def mostrar_por_id(self):
        ...
        try:
            id = ObjectId(input('Digite o Id do livro para buscar: '))
